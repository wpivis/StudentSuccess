...
export enum AppDrawerItemName {
  ...
  Offices_And_Resources = "Offices and Resources",
  Academic_Resources = "Academic Resources",
  Study_Tips = "Study Tips and Tricks From Students",
  Jobs = "Internships, Jobs, and Fellowships",
  Health = "Health & Wellbeing",
  Housing = "Housing",
  Dining = "Dining",
  Transportation = "Transportation",
  Diversity_And_Inclusion = "Diversity and Inclusion Organizations",
