    ...
    <ScrollView>
      ...
      <View style={{ backgroundColor: "#e4e4e4", width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
        <View style={{ ...dropShadow, backgroundColor: "#ffffff", width: "100%", maxWidth: 800, display: "flex", flexDirection: "column" }}>
          ...
          <PageHeader>Student Success Handbook</PageHeader>

          <ContentSection>
            {/* <CenteredTitle>What is the Student Success Handbook?</CenteredTitle> */}
            <ImageHeader image={gompeiSunset}>Our Values include Respect, Community, Inclusion, Innovation, and Achievement.</ImageHeader>
            <HeaderSubtitle>
          ...
          <View style={{ flex: 1, backgroundColor: "#f4f4f4" }}>
              <Carousel
                ...
                scrollAnimationDuration={1000}
                renderItem={({ index }) => (welcomeLetters[index])}
...
const welcomeLetters = [
  (
    <>
      <BodyText><strong>Assistant VP, DEIB</strong></BodyText>
  ...
  (
    <>
      <BodyText><strong>Dean of Undergraduates</strong></BodyText>
  ...
  (
    <>
      <BodyText><strong>Dean of Engineering</strong></BodyText>
  ...
  (
    <>
      <BodyText><strong>Dean of Arts and Sciences</strong></BodyText>
  ...
  (
    <>
      <BodyText><strong>Dean of the Business School</strong></BodyText>
  ...
  (
    <>
      <BodyText><strong>Dean of the Global School</strong></BodyText>
